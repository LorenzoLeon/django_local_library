# Generated by Django 4.2.15 on 2024-08-21 18:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text="Enter the book's natural language (e.g. English, Spanish, French, etc.)", max_length=200, unique=True)),
            ],
        ),
